<?php
/**
 * Builder script to generate universal AI workspaces for Tort, Appeals, Witness Statements, and Skeleton Arguments.
 */

$workspaces = [
    'tort_create.php' => [
        'domain_name' => 'Tort, Negligence & Personal Injury',
        'badge' => 'TORT & PERSONAL INJURY PRACTICE GROUP',
        'icon' => '🛡️',
        'subheading' => 'AI-Powered Pre-Action Protocol Letters of Claim, Particulars of Claim (PUWER/Negligence), Medical Evidence Synthesis & Judicial College Quantum Assessments',
        'ref_prefix' => 'AEP-TRT',
        'doc_types' => [
        ...
        'default_doc_type' => 'letter_of_claim',
        'default_instructions' => 'Draft a formal CPR Pre-Action Protocol Letter of Claim for workplace personal injury. Establish primary liability under PUWER 1998 and common law negligence, detail medical prognosis, and demand liability admission within 3 months.',
        'default_opponent' => 'Extract from Insurer / Defendant Denial: "We deny liability for the accident on 14 March 2024. The Claimant was an experienced operative and failed to follow verbal safety instructions. Any injuries were caused or contributed to by the Claimant\'s own negligence."',
        'default_facts' => 'On 14 March 2024, the Claimant (Marcus Vance) was operating an industrial conveyor packaging machine at the Defendant\'s warehouse premises in Manchester. The machine lacked statutory interlocking physical safety guards in breach of Regulation 11 of PUWER 1998. The Claimant\'s right arm was caught in the unshielded roller mechanism, causing complex compound fractures to the radius and ulna, nerve damage, and severe psychological shock. HSE workplace investigations confirmed repeated maintenance notices had been ignored.',
        'default_evidence' => '• HSE Statutory Accident Investigation Report & Improvement Notice
...
• 3 Witness Statements from shift coworkers confirming defective guard',
        'default_remedy' => 'General damages for PSLA (£45,000 - £65,000) plus 10% Simmons v Castle uplift; Special damages of £28,450 for past loss of earnings and medical treatment.',
        'party1_label' => 'Claimant Name:',
        'party2_label' => 'Defendant / Insurer Name:',
        'party1_default' => 'Marcus Vance (Injured Claimant)',
        'party2_default' => 'Apex Logistics UK Ltd (Defendant / Insurer)',
        'analysis_func' => 'analyseTortCase',
        'generate_func' => 'generateTortDoc',
    ],
    'appeal_create.php' => [
        'domain_name' => 'Appellate Advocacy & Grounds of Appeal',
        'badge' => 'APPELLATE ADVOCACY PRACTICE GROUP',
        'icon' => '📜',
        'subheading' => 'AI-Powered Form N161 Grounds of Appeal, Permission to Appeal Skeleton Arguments (CPR Part 52), Judicial Review Appeals & Error of Law Extraction',
        'ref_prefix' => 'AEP-APP',
        'doc_types' => [
            'grounds_of_appeal' => '📜 Form N161 Appellant\'s Grounds of Appeal',
            'skeleton_permission' => '⚖️ Skeleton Argument in Support of Permission to Appeal',
            'urgent_stay' => '🚨 Application for Urgent Stay of Execution pending Appeal',
            'reply_respondent' => '🛡️ Appellant\'s Submissions in Reply to Respondent\'s Notice'
        ],
        'default_doc_type' => 'grounds_of_appeal',
        'default_instructions' => 'Draft Form N161 Grounds of Appeal and Skeleton Argument to the Court of Appeal under CPR Part 52. Demonstrate that the trial judge misdirected themselves on the law of contractual interpretation and made findings of fact unsupported by evidence.',
        'default_opponent' => 'Extract from Respondent Notice: "The learned Judge\'s decision was an unassailable exercise of judicial discretion on primary facts. The appeal has no real prospect of success and permission should be refused as totally without merit."',
        'default_facts' => 'Judgment was delivered on 10 January 2026 in the High Court (Chancery Division) dismissing the Appellant\'s claim. The learned Judge held that Clause 12 of the Master Haulage Agreement operated as a strict condition precedent barring claim recovery. In doing so, the Judge disregarded the commercial matrix of fact and relied on an alleged verbal waiver that was never pleaded or evidenced at trial.',
        'default_evidence' => '• Sealed High Court Trial Order and Approved Approved Judgment Transcript
• Executed Commercial Haulage Agreement dated 12 January 2024
• Trial Witness Statements and contemporaneous email correspondence
• Transcripts of Trial Day 3 cross-examination confirming no verbal waiver',
        'default_remedy' => 'Order granting Permission to Appeal under CPR 52.6; Order setting aside the dismissal and entering judgment for the Appellant with costs.',
        'party1_label' => 'Appellant Name:',
        'party2_label' => 'Respondent Name:',
        'party1_default' => 'Apex Global Holdings Ltd (Appellant)',
        'party2_default' => 'TransContinental Logistics Ltd (Respondent)',
        'analysis_func' => 'analyseAppealCase',
        'generate_func' => 'generateAppealDoc',
    ],
    'witness_create.php' => [
        'domain_name' => 'Witness Statement Intelligence',
        'badge' => 'EVIDENCE & LITIGATION PRACTICE GROUP',
        'icon' => '✍️',
        'subheading' => 'AI-Powered Witness Statement Drafting strictly compliant with CPR Practice Direction 57AC, Fact Extraction, Memory Chronology & Statements of Truth',
        'ref_prefix' => 'AEP-WIT',
        'doc_types' => [
            'witness_statement' => '✍️ CPR PD 57AC Compliant Witness Statement',
            'statement_truth' => '📜 Witness Confirmation & Statement of Truth Certificate',
            'exhibit_schedule' => '📁 Exhibit Index & Contemporaneous Document Schedule',
            'supplemental_statement' => '📝 Supplemental Witness Statement in Response'
        ],
        'default_doc_type' => 'witness_statement',
        'default_instructions' => 'Draft a trial witness statement in the first person strictly complying with CPR PD 57AC. Focus on direct personal knowledge of contract negotiations on 12 January 2024 and receipt of delivery records without arguing law.',
        'default_opponent' => 'Extract from Opposing Witness Statement: "I attended the meeting on 12 January 2024. It was explicitly agreed verbally that delivery times were of the essence and that any 1-hour delay would forfeit all right to payment."',
        'default_facts' => 'The witness (Marcus Vance) is the Managing Director of the Claimant company. He conducted the negotiation meeting on 12 January 2024 alongside commercial director Sarah Jenkins. At no point was any verbal clause agreed making delivery time of the essence. The witness personally supervised all 18 freight consignments between May and August 2024 and inspected clean CMR delivery notes signed by the Defendant\'s warehouse manager.',
        'default_evidence' => '• Contemporaneous Handwritten Meeting Notes of 12 January 2024
• Email correspondence confirming agenda and executed contract terms
• 18 Clean Signed CMR Consignment Delivery Receipts
• Telephone attendance notes from credit control follow-ups',
        'default_remedy' => 'Admissibility and full weight attached to witness testimony at trial under CPR Part 32.',
        'party1_label' => 'Witness Name & Title:',
        'party2_label' => 'Party Calling Witness:',
        'party1_default' => 'Marcus Vance (Managing Director)',
        'party2_default' => 'Claimant (TransGlobal Freight Services Ltd)',
        'analysis_func' => 'analyseWitnessCase',
        'generate_func' => 'generateWitnessDoc',
    ],
    'skeleton_create.php' => [
        'domain_name' => 'Skeleton Argument Intelligence',
        'badge' => 'ADVOCACY & TRIAL SKELETON GROUP',
        'icon' => '🏛️',
        'subheading' => 'AI-Powered High Court & Tribunal Skeleton Arguments, Argument Mapping, Statutory Proposition Hierarchy & Summary Judgment Applications (CPR Part 24)',
        'ref_prefix' => 'AEP-SKL',
        'doc_types' => [
        ...
        'default_doc_type' => 'summary_judgment_skeleton',
        'default_instructions' => 'Draft an authoritative Skeleton Argument for Summary Judgment under CPR Part 24. Apply the Easyair test, establish that the defence of set-off has no real prospect of success under Gilbert-Ash, and cite clean signed CMR delivery proofs.',
        'default_opponent' => 'Extract from Defendant Defence: "The Defendant disputes the claim and contends it is entitled to set off unliquidated damages of £75,000 for alleged freight delay against invoiced sums. A full trial with cross-examination is required."',
        'default_facts' => 'The Claimant provided commercial freight services totalling £64,850.00 under a written Master Agreement. All 18 consignments were signed for cleanly without endorsement on the CMR notes. The Defendant failed to pay and raised an unparticularised set-off for alleged delay only after formal pre-action demand.',
        'default_evidence' => '• Executed Master Commercial Haulage Agreement
...
• Defendant\'s own contemporaneous warehouse delivery log',
        'default_remedy' => 'Summary Judgment for £64,850.00 plus statutory interest under Late Payment Act 1998 and costs on the indemnity basis.',
        'party1_label' => 'Applicant / Claimant:',
        'party2_label' => 'Respondent / Defendant:',
        'party1_default' => 'TransGlobal Freight Services Ltd (Applicant)',
        'party2_default' => 'Apex Logistics UK Ltd (Respondent)',
        'analysis_func' => 'analyseSkeletonCase',
        'generate_func' => 'generateSkeletonDoc',
    ],
    'advice_create.php' => [
        'domain_name' => 'Legal Advice & Merits Assessment',
        'badge' => 'LEGAL ADVICE & STRATEGIC COUNSEL GROUP',
        'icon' => '💡',
        'subheading' => 'AI-Powered Formal Legal Opinions, Merits Diagnosis (Prospects Rating), Risk Evaluation & Step-by-Step Tactical Advice',
        'ref_prefix' => 'AEP-ADV',
        'doc_types' => [
        ...
        'default_doc_type' => 'formal_advice',
        'default_instructions' => 'Provide a comprehensive formal legal advice opinion assessing prospects of success, liability analysis, risk exposure, and recommended pre-action strategy for recovery of commercial debt.',
        'default_opponent' => 'Extract from Counterparty Position: "We dispute liability in its entirety and claim an equitable set-off of £75,000 for alleged performance delays. We will resist any proceedings and seek our full legal costs."',
        'default_facts' => 'The client provided commercial haulage services under a written agreement. All 18 consignments were completed on schedule with clean signed CMR delivery proofs. The counterparty withheld £64,850.00 without legitimate contractual basis and purports to assert an unliquidated cross-claim for consequential losses.',
        'default_evidence' => '• Executed Master Commercial Haulage Agreement
...
• Written demand letters and credit control audit trail',
        'default_remedy' => 'Full principal recovery of £64,850.00 plus statutory interest under Late Payment Act 1998 and CPR Part 36 costs protection.',
        'party1_label' => 'Client Name:',
        'party2_label' => 'Counterparty Name:',
        'party1_default' => 'TransGlobal Freight Services Ltd (Client)',
        'party2_default' => 'Apex Logistics UK Ltd (Counterparty)',
        'analysis_func' => 'analyseAdviceCase',
        'generate_func' => 'generateAdviceDoc',
    ]
];

function generateWorkspaceFile(string $filename, array $cfg): string {
    $docTypesPhp = var_export($cfg['doc_types'], true);
    $defaultDocType = $cfg['default_doc_type'];
    $domainName = addslashes($cfg['domain_name']);
    $badge = addslashes($cfg['badge']);
    $icon = $cfg['icon'];
    $subheading = addslashes($cfg['subheading']);
    $refPrefix = $cfg['ref_prefix'];
    $defInstructions = addslashes($cfg['default_instructions']);
    $defOpponent = addslashes($cfg['default_opponent']);
    $defFacts = addslashes($cfg['default_facts']);
    $defEvidence = addslashes($cfg['default_evidence']);
    $defRemedy = addslashes($cfg['default_remedy']);
    $party1Label = addslashes($cfg['party1_label']);
    $party2Label = addslashes($cfg['party2_label']);
    $party1Default = addslashes($cfg['party1_default']);
    $party2Default = addslashes($cfg['party2_default']);
    $analysisFunc = $cfg['analysis_func'];
    $generateFunc = $cfg['generate_func'];
...
// Initial State
\$targetDocType = \$_POST['target_doc_type'] ?? '{$defaultDocType}';
\$instructions   = trim((string)(\$_POST['instructions'] ?? '{$defInstructions}'));
\$opponentText   = trim((string)(\$_POST['opponent_text'] ?? '{$defOpponent}'));
\$factsText      = trim((string)(\$_POST['facts'] ?? '{$defFacts}'));
\$evidenceText   = trim((string)(\$_POST['evidence_available'] ?? '{$defEvidence}'));
\$remedyText     = trim((string)(\$_POST['remedy_requested'] ?? '{$defRemedy}'));

\$party1         = trim((string)(\$_POST['client_name'] ?? '{$party1Default}'));
\$party2         = trim((string)(\$_POST['opposing_party'] ?? '{$party2Default}'));
\$matterRef      = trim((string)(\$_POST['case_reference'] ?? ('{$refPrefix}-' . date('Y') . '-' . rand(100, 999))));
...
\$outputTitle    = \$_POST['output_title'] ?? 'AI {$domainName} Workspace DRAFT';
...
if (\$action === 'sample') {
    ...
    \$opponentText = '{$defOpponent}';
    \$factsText = '{$defFacts}';
    \$evidenceText = '{$defEvidence}';
    \$remedyText = '{$defRemedy}';
    \$party1 = '{$party1Default}';
    \$party2 = '{$party2Default}';
...
// Execute Analysis
\$analysis = {$analysisFunc}(\$caseData);
...
if (in_array(\$action, ['generate', 'draft', 'generate_draft', 'analyse'])) {
    \$doc = {$generateFunc}(\$analysis, \$caseData, ['reference' => \$matterRef], \$targetDocType);
...
if (\$outputDraft === '' && \$action !== 'reset') {
    \$doc = {$generateFunc}(\$analysis, \$caseData, ['reference' => \$matterRef], \$targetDocType);
    \$outputDraft = \$doc['content'] ?? (\$doc['draft'] ?? (\$doc['Generated Draft']['content'] ?? ''));
    \$outputTitle = \$doc['title'] ?? 'AI {$domainName} Workspace DRAFT';
}
...
if (\$action === 'save_matter') {
    try {
        \$mId = \$selectedMatter;
        if (\$mId === 0) {
            \$stmt = \$pdo->prepare("INSERT INTO matters (reference, title, client_name, practice_area, status, created_at, updated_at) VALUES (?, ?, ?, '{$domainName}', 'open', datetime('now'), datetime('now'))");
            \$stmt->execute([\$matterRef, '{$domainName}: ' . (\$party1 ?: 'Dispute'), \$party1]);
        ...
        \$dStmt->execute([\$mId, \$outputTitle ?: 'AI {$domainName} Draft', \$outputDraft, \$_SESSION['user_id'] ?? 1]);
...
\$docTypes = {$docTypesPhp};
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>AI {$domainName} Workspace — AEP Legal Intelligence Platform</title>
...
<header class="workspace-header">
    <div class="workspace-title">
        <h1>{$icon} {$domainName} Workspace</h1>
        <p>{$subheading}</p>
    </div>
    <nav class="top-nav">
...
function exportWord() {
    ...
    a.href = url;
    a.download = '{$refPrefix}_Draft_' + new Date().toISOString().slice(0,10) + '.doc';
...
foreach ($workspaces as $file => $cfg) {
    $code = generateWorkspaceFile($file, $cfg);
    file_put_contents(__DIR__ . '/' . $file, $code);
    echo "Generated AI Workspace: {$file}\n";
}
