...
<div class="container">
  <div class="card">
    ...
    <h2>✉️ Letter Record</h2>
    <p class="sub">
      Ref No: <strong><?php echo htmlspecialchars($r['ref_no'] ?: 'N/A'); ?></strong>
      &nbsp;|&nbsp;
    ...
    <div class="btn-row">
      <a href="letter_print.php?id=<?php echo $r['id']; ?>" class="btn btn-primary" target="_blank">🖨 Print / PDF</a>
      <a href="letter_list.php" class="btn btn-secondary">← Back to List</a>
    ...
    <div class="section">
      ...
      <div class="detail-grid">
        <div class="detail-item">
          ...
          <div class="detail-value"><?php echo htmlspecialchars($r['ref_no'] ?: '—'); ?></div>
        </div>
        <div class="detail-item">
          <div class="detail-label">Letter Type</div>
          <div class="detail-value"><?php echo htmlspecialchars($r['letter_type'] ?: '—'); ?></div>
        </div>
      </div>
    </div>
    ...
    <div class="section">
      ...
      <div class="detail-grid">
        <div class="detail-item">
          ...
          <div class="detail-value"><?php echo htmlspecialchars($r['recipient_name']); ?></div>
        </div>
        <div class="detail-item">
          <div class="detail-label">Salutation</div>
          <div class="detail-value"><?php echo htmlspecialchars($r['salutation'] ?: '—'); ?></div>
        </div>*
