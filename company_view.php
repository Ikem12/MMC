...
<head>
    <meta charset="UTF-8">
    <title>View <?= htmlspecialchars($record['case_reference'] ?? 'Record') ?> — Corporate Law & Shareholder Intelligence</title>
...
<header class="topbar">
    <div style="font-weight: 700; font-size: 15px;">⚖️ AEP Legal Platform — Corporate Law & Shareholder Intelligence</div>
    <nav>
        <a href="company_list.php">📋 Back to List</a>
        <a href="company_create.php">⚡ AI Workspace</a>
...
<div class="container">
    <div class="card">
        <div class="header-actions">
            <div>
                <h1 style="margin: 0; font-size: 20px; color: #0f2744;">🏢 <?= htmlspecialchars($record['company_name'] ?? 'Record Details') ?></h1>
            ...
            <div style="display: flex; gap: 10px;">
                <a href="company_print.php?id=<?= $record['id'] ?>" target="_blank" class="btn btn-outline">🖨 Print / PDF</a>
                <a href="company_create.php?id=<?= $record['id'] ?>" class="btn btn-primary">⚡ Open in AI Workspace</a>
            </div>
        </div>
        ...
        <div class="grid-2">
            <div class="field-group">
                ...
                <div class="field-val"><?= htmlspecialchars($record['petitioner_name'] ?? 'N/A') ?></div>
            </div>
            <div class="field-group">
        ...
        <div class="full-content"><?= htmlspecialchars($record['prejudice_details'] ?? 'No extended content recorded.') ?></div>
    </div>
</div>
